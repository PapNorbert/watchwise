...
import { createCommentKey } from '../util/util.js'
  ...
  if (parseInt(request.params.thread_id) == request.params.thread_id ) { // correct parameter
    ...
    try {
      ...
      if (commentJson.user != "" && commentJson.user != null) {
        ...
        commentJson.key = createCommentKey(commentJson.user, Date.now());
          // key generated by the time concated with every second letter of the user
          // completed at the beggining so that it's minimum 24 long
