...
series_embeddings_w2v_file_path = './data/series_w_embedding_w2v_pgda_data.csv'

movie_embeddings_st_file_path = './data/movies_w_embedding_st_npgda_data.csv'
series_embeddings_st_file_path = './data/series_w_embedding_st_npgda_data.csv'

movie_embeddings_st_ext_file_path = './data/movies_w_embedding_st_ext_npgda_data.csv'
series_embeddings_st_ext_file_path = './data/series_w_embedding_st_ext_npgda_data.csv'

movie_embeddings_st_ext_20ep_file_path = './data/movies_w_embedding_st_ext_20_epoch_npgda_data.csv'
series_embeddings_st_ext_20ep_file_path = './data/series_w_embedding_st_ext_20_epoch_npgda_data.csv'
...
def load_data_to_database():
    ...
    movie_embeddings = read_movie_embeddings(movie_embeddings_st_ext_20ep_file_path)
    serie_embeddings = read_serie_embeddings(series_embeddings_st_ext_20ep_file_path)
